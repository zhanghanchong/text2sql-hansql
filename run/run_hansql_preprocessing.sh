...
python -u preprocess/process_graphs.py --dataset_path 'data/train.bin' --table_path $table_out --metapath_path $metapath_out --q_metapath -1 16 4 --t_metapath -1 13 6 --c_metapath -1 25 9 --method 'hansql' --output_path $train_out
python -u preprocess/process_graphs.py --dataset_path 'data/dev.bin' --table_path $table_out --metapath_path $metapath_out --q_metapath -1 16 4 --t_metapath -1 13 6 --c_metapath -1 25 9 --method 'hansql' --output_path $dev_out
