...
python -u preprocess/process_dataset.py --dataset_path $train_data --raw_table_path $table_data --table_path $table_out --output_path 'data/train.bin' --skip_large #--verbose > train.log
echo "Start to preprocess the original dev dataset ..."
python -u preprocess/process_dataset.py --dataset_path $dev_data --table_path $table_out --output_path 'data/dev.bin' #--verbose > dev.log
...
python -u preprocess/process_lgesql_graphs.py --dataset_path 'data/train.bin' --table_path $table_out --method 'lgesql' --output_path $train_out
python -u preprocess/process_lgesql_graphs.py --dataset_path 'data/dev.bin' --table_path $table_out --method 'lgesql' --output_path $dev_out
